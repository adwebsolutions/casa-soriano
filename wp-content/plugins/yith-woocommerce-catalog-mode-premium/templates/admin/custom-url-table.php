					...
					'options' => array(
						...
						'custom_columns'   => array(
							...
							'column_custom_url' => function ( $item, $me ) {
								...
								return sprintf( '%s%s', $button_url_type, $button_url );
					...
					'options' => array(
						...
						'custom_columns'   => array(
							...
							'column_custom_url' => function ( $item, $me ) {
								...
								if ( YITH_WCTM()->is_wc_lower_2_6 ) {

									if ( get_woocommerce_term_meta( $item['ID'], '_ywctm_exclude_button' . $this->get_vendor_id(), true ) == 'yes' ) {
										return __( 'Excluded from custom button', 'yith-woocommerce-catalog-mode' );
									}

									$protocol = get_woocommerce_term_meta( $item['ID'], '_ywctm_custom_url_protocol' . $this->get_vendor_id(), true );
									$link     = get_woocommerce_term_meta( $item['ID'], '_ywctm_custom_url_link' . $this->get_vendor_id(), true );
						...
						case 'categories':
							...
							foreach ( $category_ids as $category_id ) {
								...
								if ( YITH_WCTM()->is_wc_lower_2_6 ) {
									...
									update_woocommerce_term_meta( $category_id, '_ywctm_custom_url_enabled' . $this->get_vendor_id(), $enable_url );
									update_woocommerce_term_meta( $category_id, '_ywctm_exclude_button' . $this->get_vendor_id(), $exclude );
									update_woocommerce_term_meta( $category_id, '_ywctm_custom_url_protocol' . $this->get_vendor_id(), $protocol );
									update_woocommerce_term_meta( $category_id, '_ywctm_custom_url_link' . $this->get_vendor_id(), $link );
						...
						case 'tags':
							...
							foreach ( $tag_ids as $tag_id ) {
								...
								if ( YITH_WCTM()->is_wc_lower_2_6 ) {
									...
									update_woocommerce_term_meta( $tag_id, '_ywctm_custom_url_enabled' . $this->get_vendor_id(), $enable_url );
									update_woocommerce_term_meta( $tag_id, '_ywctm_exclude_button' . $this->get_vendor_id(), $exclude );
									update_woocommerce_term_meta( $tag_id, '_ywctm_custom_url_protocol' . $this->get_vendor_id(), $protocol );
									update_woocommerce_term_meta( $tag_id, '_ywctm_custom_url_link' . $this->get_vendor_id(), $link );
				...
				switch ( $current_section ) {
					...
					case'categories':
						...
						if ( YITH_WCTM()->is_wc_lower_2_6 ) {
							...
							$item = array(
								'ID'                => $_GET['id'],
								'enable_custom_url' => get_woocommerce_term_meta( $_GET['id'], '_ywctm_custom_url_enabled' . $this->get_vendor_id(), true ),
								'exclude'           => get_woocommerce_term_meta( $_GET['id'], '_ywctm_exclude_button' . $this->get_vendor_id(), true ),
								'protocol'          => get_woocommerce_term_meta( $_GET['id'], '_ywctm_custom_url_protocol' . $this->get_vendor_id(), true ),
								'link'              => get_woocommerce_term_meta( $_GET['id'], '_ywctm_custom_url_link' . $this->get_vendor_id(), true ),
							);
