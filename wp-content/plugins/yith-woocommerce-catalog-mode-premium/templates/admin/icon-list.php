    ...
    public static function output( $option ) {
        ...
        <tr valign="top">
            ...
            <td class="forminp forminp-<?php echo sanitize_title( $option['type'] ) ?>">
                ...
                <div class="icon-option icon-list">
                    <div class="icon-manager-text">
                        <div class="icon-preview" <?php echo $current_icon; ?>></div>
                        <input type="text" id="<?php echo $option['id']; ?>[icon]" class="icon-text" name="<?php echo $option['id']; ?>[icon]" value="<?php echo $current_options['icon']; ?>" />
                    </div>
