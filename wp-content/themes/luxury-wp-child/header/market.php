			...
			<div class="row">
				...
				<div class="col-sm-6 col-right-topbar">
					<div class="right-topbar">
            			...
            			<?php endif; ?>
						<?php
							$right_topbar_content = dh_get_theme_option('right-topbar-content','info');
							if($right_topbar_content === 'info'):
								echo '<div class="topbar-info">';
								if($right_topbar_phone = dh_get_theme_option('right-topbar-phone','(123) 456 789'))
									echo '<a href="#"><i class="fa fa-phone"></i> '.esc_html($right_topbar_phone).'</a>';
								if($right_topbar_email = dh_get_theme_option('right-topbar-email','info@example.com'))
									echo '<a href="mailto:'.esc_attr($right_topbar_email).'"><i class="fa fa-envelope-o"></i> '.esc_html($right_topbar_email).'</a>';
								if($right_topbar_skype = dh_get_theme_option('right-topbar-skype','skype.name'))
									echo '<a href="skype:'.esc_attr($ryght_topbar_skype).'?call"><i class="fa fa-skype"></i> '.esc_html($right_topbar_skype).'</a>';
								echo '</div>';
							elseif ($right_topbar_content === 'custom'):
								echo (dh_get_theme_option('right-topbar-custom-content',''));
							endif;
							?>
							<?php
							if(($right_topbar_content == 'menu_social')):
								echo '<div class="topbar-social">';
								dh_social(dh_get_theme_option('right-topbar-social',array('facebook','twitter','google-plus','pinterest','rss','instagram')),true);
								echo '</div>';
							endif;
						?>
					</div>
												...
												<div class="searchinput-wrap">
													...
													<div class="search-product-category">
														<div class="form-flat-select">
															<?php
												        		wc_product_brand_dropdown_categories(
												            		array(
												                		'show_counts'        => 0,
																		'hierarchical'       => 0,
