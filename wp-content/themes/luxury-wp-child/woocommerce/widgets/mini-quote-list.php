...
<?php do_action( 'ywraq_before_raq_list_widget' ); ?>
	<div class="raq-info">
		<a class="raq_label" href="<?php echo YITH_Request_Quote()->get_raq_page_url(); ?>">
				<span class="raq-items-number"><?php echo $num_items ?></span>
		</a>
		<img src="<?php echo get_stylesheet_directory_uri() . '/assets/quote_bag.jpg'; ?>" alt="Request a Quote">
	</div>
		...
		<div class="yith-ywraq-list-content">
			<ul class="yith-ywraq-list">
				...
				<?php endforeach ?>
					...
					<a class="page-btn" href="<?php echo YITH_Request_Quote()->get_raq_page_url() ?>" class="button"><?php echo apply_filters( 'yith_ywraq_quote_list_button_label', __( 'View list', 'yith-woocommerce-request-a-quote' ) ) ?></a>
