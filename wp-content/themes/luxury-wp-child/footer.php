...
<?php if(!dh_get_post_meta('hide_footer',0)):?>
	<footer id="footer" class="footer<?php echo (dh_get_theme_option('footer-fixed',0) ?' footer-fixed':'') ?>" role="contentinfo">
		...
		<div class="footer-info clearfix">
			<div class="<?php dh_container_class() ?>">
				<div class="row">
					<div class="<?php echo ((dh_get_theme_option('footer-menu',1)||($footer_credit = dh_get_theme_option('footer-credit'))) ? 'col-sm-6':'col-sm-12 text-center')?>">
					...
					<?php endif;?>
					<?php if($footer_credit = dh_get_theme_option('footer-credit')):?>
					<div class="col-sm-6">
