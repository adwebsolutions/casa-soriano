...
class WC_Widget_Custom_Product_Categories extends WC_Widget {
	...
	public function __construct() {
		...
		$this->widget_id          = 'woocommerce_custom_product_categories';
		$this->widget_name        = __( 'WooCommerce custom product categories', 'woocommerce' );
		$this->settings           = array(
			'title'  => array(
				'type'  => 'text',
