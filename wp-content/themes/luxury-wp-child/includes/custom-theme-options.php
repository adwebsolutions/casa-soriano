...
// 							),
                        ...
                        array(
                            ...
                            'type' => 'buttonset',
                            'dependency' => array('element'=>'show-topbar','value'=>array('1')),
                            'label' => __('Right topbar content', 'luxury-wp'),
                            'options' => array(
                                'none'=>__('None','luxury-wp'),
                                'menu_social'=>__('Social','luxury-wp'),
                                'info'=>__('Site Info','luxury-wp'),
                        ...
                        array(
                            'name' => 'right-topbar-phone',
                            'type' => 'text',
                            'dependency' => array('element'=>'right-topbar-content','value'=>array('info')),
                            'label' => __('Phone number','luxury-wp'),
                            'value'=>'(123) 456 789'
                        ),
                        array(
                            'name' => 'right-topbar-email',
                            'type' => 'text',
                            'dependency' => array('element'=>'right-topbar-content','value'=>array('info')),
                            'label' => __('Email','luxury-wp'),
                            'value'=>'info@domain.com'
                        ...
                        array(
                            ...
                            'label' => __('Right Topbar Content Custom HTML', 'luxury-wp'),
                            'value'=>'Shop unique and handmade items directly'
                        ),
                        /**/
                        array(
                ...
                'footer'=>array(
                    ...
                    'fields'=>array(
                        ...
                        array(
                            'name' => 'footer-credit',
                            'type' => 'text',
                            'label' => __('Footer Credit','luxury-wp'),
                            'value' => 'Diseño y Desarrollo Web por <a href="http://www.adwebsdesign.com/" target="_blank">ADWEB design</a>. Una empresa del Grupo <a href="http://www.adwebsolutions.com/" target="_blank">ADWEB Solutions</a>'
                        ),
                        array(
                            'name' => 'footer-social',
                            'type' => 'muitl-select',
